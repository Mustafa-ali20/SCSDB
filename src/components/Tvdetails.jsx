      ...
      >
        ...
        <div className="hidden lg:block px-[10%] relative">
          <nav className="w-full h-[10vh] items-center flex gap-10 text-xl">
            <Link
              onClick={() => navigate(-1)}
              className="ri-arrow-left-line mr-2 hover:text-[#6656CD] hover:scale-125 transition-all duration-200 cursor-pointer"
            ></Link>
            <a
            ...
            >
              <i className="ri-external-link-line transition-transform duration-300 hover:scale-115"></i>
            </a>
            <a
              className="transition-transform duration-300 hover:scale-115 hover:text-[#6656CD]"
              target="_blank"
            ...
            <a
              ...
              className="px-3 py-1 hover:scale-110 bg-yellow-400 text-white rounded hover:bg-yellow-500 transition-all duration-200 font-semibold"
            ...
            <div className="content ml-10">
              ...
              <div className="flex flex-wrap items-center gap-6 mt-6 p-4 bg-black/30 backdrop-blur-sm rounded-xl border border-white/10">
                ...
                <div className="flex items-center gap-2 px-3 py-2 bg-blue-600/20 rounded-lg border border-blue-400/30">
                  ...
                  <span className="text-white font-medium">{info?.detail?.first_air_date}</span>
                </div>
                ...
                <div className="flex items-center gap-2 px-3 py-2 bg-green-600/20 rounded-lg border border-green-400/30">
                  ...
                  <span className="text-white font-medium">
                    {info?.detail?.episode_run_time?.length > 0
                      ? `${info?.detail?.episode_run_time[0]} min/ep`
              ...
              <p className="text-white w-[80%] mt-2">{info?.detail?.overview}</p>
          ...
          {info?.detail?.seasons?.length > 0 ? (
            <>
              <h1 className="text-2xl font-semibold ml-6 mb-5">Seasons:</h1>
              <HorizontalCards data={info?.detail?.seasons} />
            </>
          ) : (
            <h1 className="text-2xl font-semibold ml-6 mb-5">No Seasons</h1>
          )}
        ...
        <div className="lg:hidden px-4 py-6">
          ...
          <nav className="flex justify-between items-center mb-6">
            <Link
              onClick={() => navigate(-1)}
              className="ri-arrow-left-line text-2xl hover:text-[#6656CD] hover:scale-125 transition-all duration-200 cursor-pointer p-2"
            ></Link>
          ...
          <div className="mb-6">
            ...
            <p className="text-white leading-relaxed">{info?.detail?.overview}</p>
          </div>
          ...
          {info?.detail?.seasons?.length > 0 ? (
            <div className="mb-8">
              <h2 className="text-xl font-semibold mb-4 text-center">Seasons</h2>
              <HorizontalCards data={info?.detail?.seasons} />
            </div>
          ) : (
            <div className="mb-8">
              <h2 className="text-xl font-semibold text-center text-zinc-400">No Seasons Available</h2>
            </div>
          )}
